...
import com.payAm.core.ebean.exception.DependencyException;
 ...
 */
public abstract class BaseDao<I extends Serializable, E extends BaseEntity> /*extends Find<I, E>*/ {
...
//    private Messages messages;
    ...
    public E load(E entty, final I id) throws EntityNotFoundException {
        E entity = (E) entty.byId(id);
        if (entity == null) {
